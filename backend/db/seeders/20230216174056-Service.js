  ...
  async up(queryInterface, Sequelize) {
    const types = [
      ...
      },
      {
        ...
        body: "Мануальная терапия – это направление медицины, основой которого является лечение патологических процессов в позвоночнике, суставах и мышцах при помощи ручных приемов.",
        img: "https://novitaclinic.ru/thumb/2/gofxYuRuuln9o-Nfc722uA/360r300/d/manualnaya_terapiya.jpg",
        price: "стоимость услуги от 1500р",
      },
      {
        title: "Терапия",
        body: "Процесс, целью которого является устранение заболевания или травмы, патологического состояния или иного нарушения жизнедеятельности, нормализация нарушенных процессов жизнедеятельности, восстановление и улучшение здоровья.",
        img: "https://avatars.mds.yandex.net/i?id=24aeb48b29419ddb4dd77e7f70d9f0d916c207f1-8358323-images-thumbs&n=13",
        price: "стоимость услуги от 1000р",
      },
    ];
